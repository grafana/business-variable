...
/**
 * Inlined from @volkovlabs/components useDatasourceRequest.test.ts
 * (https://github.com/grafana/volkov-packages/blob/main/packages/components/src/hooks/useDatasourceRequest.test.ts).
 */
