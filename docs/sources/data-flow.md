...
{{< figure src="/media/docs/grafana/panels-visualizations/business-variable/flow-reg-panel.png" class="border" alt="Data flow when working with a regular Grafana visualization panel." >}}
...
{{< figure src="/media/docs/grafana/panels-visualizations/business-variable/flow-var-panel.png" class="border" alt="Data flow when working with the Business Variable panel." >}}
