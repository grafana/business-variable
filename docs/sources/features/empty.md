...
{{< figure src="/media/docs/grafana/panels-visualizations/business-forms/multi-value.png" class="border" alt="Multi-value setting for dashboard variables." >}}

For this feature to work, you must enable the **Allow empty value** parameter in the **Values** category.

{{< figure src="/media/docs/grafana/panels-visualizations/business-forms/empty-all.png" class="border" alt="When Allow empty value is enabled, a user can unselect all variable values." >}}
