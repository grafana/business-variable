...
A [_dashboard variable_] is a set of values retrieved following rules set by a dashboard developer. For simplicity, we call these rules a _dashboard variable query_.
